...
const Academy = () => {
    ...
    const graduationImages = [
        { img: course1, name: "Aisha R." },
        { img: course2, name: "Sneha M." },
        { img: course3, name: "Divya K." },
        { img: heroBg, name: "Riya S." }
    ];
    ...
    const courses = [
        { img: course1, title: "Professional Makeup Course", desc: "A comprehensive masterclass covering everything from basics to advanced bridal artistry." },
        { img: course2, title: "Bridal Makeup Course", desc: "Specialized focus on traditional and contemporary bridal looks across different cultures." },
        { img: course3, title: "Self Makeup Course", desc: "Perfect for individuals wanting to master their own everyday and party looks flawlessly." },
        { img: heroBg, title: "Advanced Techniques", desc: "Masterclasses in airbrush, HD makeup, and intricate prosthetic SFX styling." }
    ];
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {courses.map((course, idx) => (
                            <FadeIn key={idx} delay={idx * 0.15} direction="up">
                                <div className="bg-[#0a0a0a] rounded-sm overflow-hidden border border-luxury-gold/10 group flex flex-col h-full hover:shadow-[0_10px_30px_rgba(0,0,0,0.8)] transition-all duration-500">
                                    ...
                                    <div className="p-6 flex flex-col flex-grow">
                                        <h3 className="text-lg font-serif text-luxury-gold mb-3">{course.title}</h3>
                                        <p className="text-[#999999] text-sm font-light leading-relaxed mb-6 flex-grow">{course.desc}</p>
                                        <Link to="/course-details" className="text-xs tracking-[0.15em] uppercase text-white font-medium flex items-center gap-2 group-hover:text-luxury-gold transition-colors w-max">
            ...
            <section className="py-24 px-6 bg-[#0a0a0a]">
                <div className="container mx-auto max-w-6xl">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {courses.map((course, idx) => (
                            <FadeIn key={idx} delay={idx * 0.1} direction="up">
                                <div className="aspect-[4/5] overflow-hidden rounded-sm group relative">
                                    <div className="absolute inset-0 bg-black/40 group-hover:bg-black/10 transition-colors duration-500 z-10"></div>
                                    <img src={course.img} alt={"Student Work " + idx} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                ...
                <div className="container mx-auto max-w-6xl relative z-10">
                    ...
                    <FadeIn direction="up">
                        <div className="relative overflow-hidden py-4 -mx-6 px-6 md:mx-0 md:px-0 group">
                            ...
                            >
                                {graduationImages.concat(graduationImages).map((item, idx) => (

...
const Home = () => {
    ...
    const [sliderImages, setSliderImages] = useState({
        b: "https://images.unsplash.com/photo-1544148103-0773bf10d330?auto=format&fit=crop&q=80&w=1200",
        a: "https://images.unsplash.com/photo-1596462502278-27bfdc403348?auto=format&fit=crop&q=80&w=1200"
    });
                ...
                <AnimatePresence>
                    ...
                    >
                        ...
                        <img
                            ...
                            alt={`Bridal Makeup Beauty ${currentImageIndex + 1}`}
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12 lg:gap-16">
                            ...
                            <div className="relative group w-full max-w-[300px] sm:max-w-[400px] lg:max-w-[460px]">
                                ...
                                <div className="relative rounded-t-full rounded-b-[24px] md:rounded-b-[32px] overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.6)] md:shadow-[0_15px_40px_rgba(0,0,0,0.6)] group-hover:shadow-[0_20px_50px_rgba(212,175,55,0.15)] transition-shadow duration-700 bg-[#080808] border border-luxury-gold/10">
                                    ...
                                    <img
                                        ...
                                        alt="Award Winning Artist"
                                        className="w-full h-[320px] sm:h-[480px] lg:h-[560px] object-cover object-top transform transition-transform duration-1000 group-hover:scale-105"
                                    />
                                </div>
                            </div>
                        </FadeIn>
                        ...
                        <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:items-start text-center lg:text-left">
                            <FadeIn delay={0.2} direction="up" className="w-full">
                                <span className="text-luxury-gold text-[10px] md:text-sm tracking-[0.2em] md:tracking-[0.3em] uppercase mb-2 md:mb-4 block font-medium">Meet the Artist Behind the Excellence</span>
                                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-serif mb-3 md:mb-6 text-luxury-nude leading-[1.15] md:leading-[1.2]">
                                    Award-Winning Artist & <br className="hidden lg:block" /> <span className="text-luxury-gold italic">World Record Holder</span>
                                </h2>
                                ...
                                <p className="text-luxury-nude/90 text-base md:text-lg lg:text-xl font-light mb-3 md:mb-6 italic border-l-2 border-luxury-gold pl-3 md:pl-4 sm:mx-auto max-w-lg lg:max-w-none lg:mx-0 leading-snug">
                                    "Crafting timeless bridal looks with precision, passion, and global recognition."
                                </p>
                                ...
                                <p className="text-luxury-nude/70 text-[13px] md:text-base leading-snug md:leading-relaxed font-light mb-6 md:mb-10 max-w-lg sm:mx-auto lg:mx-0">
                                    Recognized as a <span className="text-luxury-gold">World Record Holder</span> in Professional Makeup Artistry, delivering unmatched expertise and elegance to ensure every bride radiates timeless beauty.
                                </p>
                        ...
                        {[
                            {
                                ...
                                desc: "Experience unparalleled luxury with our custom bridal makeup tailored to enhance your natural beauty.",
                                price: "₹15,000"
                            },
                            {
                                title: "Engagement Looks",
                                img: "https://images.unsplash.com/photo-1512496015851-a1c8dcbc69cd?q=80&w=800&auto=format&fit=crop",
                                desc: "Radiate elegance on your special day with our flawless, long-lasting engagement makeup services.",
                                price: "₹10,000"
                            },
                            {
                                title: "Party Makeup",
                                img: "https://images.unsplash.com/photo-1487412947147-5cebf100ffc2?q=80&w=800&auto=format&fit=crop",
                                desc: "Stand out at any event with our signature party glam, customized for day or evening occasions.",
                                price: "₹5,000"
                            }
                        ].map((service, idx) => (
                            <StaggerItem key={idx}>
                                    ...
                                    <div className="p-6 md:p-8 flex flex-col justify-between flex-grow md:absolute md:inset-0 md:z-10 md:justify-end">
                                        <div className="md:transform md:translate-y-[85px] md:group-hover:translate-y-0 transition-transform duration-700 ease-[cubic-bezier(0.25,1,0.5,1)] flex flex-col h-full md:h-auto">
                                            ...
                                            <div className="md:opacity-0 md:group-hover:opacity-100 transition-all duration-700 mt-3 md:mt-4 flex flex-col justify-between flex-grow md:flex-grow-0">
                                                ...
                                                <div className="flex justify-between items-center w-full mt-auto md:mt-0">
                                                    <span className="text-luxury-nude/90 text-xs sm:text-sm font-medium tracking-wide bg-luxury-gold/10 px-3 py-1.5 rounded border border-luxury-gold/20">
                                                        From {service.price}
                                                    </span>
                    ...
                    <div className="lg:hidden flex flex-col items-center text-center mb-10 relative z-20">
                        <FadeIn direction="up">
                            ...
                            <div className="inline-flex items-center justify-center gap-2 mb-4 px-4 py-1.5 rounded-full bg-gradient-to-r from-[#1a150b] via-[#2a2215] to-[#1a150b] border border-luxury-gold/30 shadow-[0_5px_15px_rgba(201,164,92,0.15)]">
                                ...
                                <span className="text-luxury-gold text-[10px] sm:text-xs uppercase tracking-[0.15em] font-medium">Top Rated Course</span>
                            </div>

                            {/* Short Heading */}
                            <h2 className="text-3xl sm:text-4xl font-serif text-white mb-4 drop-shadow-md px-2">
                                Master the Art of <span className="text-luxury-gold italic">Makeup</span>
                            </h2>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-0 lg:gap-16 bg-[#080808] lg:bg-transparent rounded-3xl lg:rounded-none border border-luxury-gold/10 lg:border-none shadow-2xl lg:shadow-none overflow-hidden lg:overflow-visible relative">
                        ...
                        <div className="w-full lg:w-1/2 flex flex-col items-start text-left order-2 lg:order-1 p-5 md:p-6 sm:p-8 lg:p-0">
                            <FadeIn direction="up" className="w-full">
                                ...
                                <div className="hidden lg:block">
                                    <span className="text-luxury-gold text-xs lg:text-sm tracking-[0.2em] lg:tracking-[0.3em] uppercase mb-3 lg:mb-4 block font-medium">Nithya Beauty Academy</span>
                                    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif mb-4 lg:mb-6 text-luxury-nude leading-[1.2]">
                                        Become a <span className="text-luxury-gold italic">Professional</span> <br className="hidden lg:block" /> Makeup Artist
                                    </h2>
                                </div>

                                <div className="flex flex-wrap items-center gap-2 md:gap-3 lg:gap-4 mb-4 md:mb-5 lg:mb-6 lg:mt-0">
                                    <span className="bg-luxury-gold/10 border border-luxury-gold/20 px-2 md:px-3 py-1 md:py-1.5 rounded text-luxury-gold text-[9px] md:text-[10px] sm:text-xs tracking-wider uppercase font-medium">Premium Course</span>
                                    ...
                                    <span className="text-luxury-nude/70 text-[10px] md:text-xs sm:text-sm font-light">Premium Pricing</span>
                                </div>
                                ...
                                <p className="text-luxury-nude/90 text-sm md:text-[15px] lg:text-xl font-light mb-3 md:mb-4 lg:mb-6 leading-snug md:leading-normal">
                                    Learn from a World Record Holding Artist and build your career in the beauty industry.
                                </p>
                                ...
                                <p className="text-luxury-nude/70 text-[13px] md:text-sm lg:text-base leading-snug lg:leading-relaxed font-light mb-5 md:mb-6 lg:mb-8 max-w-lg">
                                    Our academy offers hands-on training, industry techniques, and personalized guidance to help you become a <span className="text-luxury-gold">certified</span> makeup professional.
                                </p>
                        ...
                        <FadeIn delay={0.2} direction="up" className="w-full lg:w-1/2 order-1 lg:order-2">
                            <div className="relative group max-w-none w-full">
                                ...
                                <div className="hidden lg:block absolute inset-0 border border-luxury-gold/20 rounded-[40px] rounded-tl-full transform -translate-x-4 -translate-y-4 transition-transform duration-700 group-hover:-translate-x-2 group-hover:-translate-y-2"></div>
                                <div className="relative lg:rounded-[40px] lg:rounded-tl-full overflow-hidden lg:shadow-2xl lg:bg-[#080808]">
                                    ...
                                    <img
                                        ...
                                        className="w-full aspect-video sm:aspect-[16/7] lg:aspect-auto lg:h-[600px] object-cover object-center transform transition-transform duration-1000 group-hover:scale-105"
                                    />
                                </div>
                            </div>
                        </FadeIn>
                ...
                <div className="container mx-auto max-w-6xl relative z-10">
                    <div className="text-center mb-16 max-w-3xl mx-auto">
                        <FadeIn direction="up">
                            ...
                            <h2 className="text-4xl sm:text-5xl font-serif text-luxury-nude mb-6">Real <span className="text-luxury-gold italic pr-2">Transformations</span></h2>
                            ...
                            <p className="text-luxury-nude/70 font-light text-base md:text-lg leading-relaxed px-4">
                                Experience the power of professional artistry. We enhance natural features to reveal the most breathtaking version of you.
                            </p>
                        </FadeIn>
                    </div>

                    {/* Main Interaction Slider */}
                    <FadeIn direction="up" delay={0.2} className="mb-20 max-w-4xl lg:max-w-5xl mx-auto">
                        <div id="main-slider" className="relative group rounded-3xl p-1.5 sm:p-2 bg-[#080808] border border-luxury-gold/20 shadow-[0_20px_50px_rgba(201,164,92,0.05)]">
                            <BeforeAfterSlider
                    ...
                    <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                        {[
                            {
                                b: "https://images.unsplash.com/photo-1542039304-7a329d5b51dd?q=80&w=600&auto=format&fit=crop",
                                a: "https://images.unsplash.com/photo-1592878904946-b3cd8ae243d0?q=80&w=600&auto=format&fit=crop",
                                title: "Reception Glam"
                            },
                            {
                                b: "https://images.unsplash.com/photo-1512496015851-a1c8dcbc69cd?q=80&w=600&auto=format&fit=crop",
                                a: "https://images.unsplash.com/photo-1557205465-f3762edea6d3?q=80&w=600&auto=format&fit=crop",
                                title: "Haldi Glowing Look"
                            },
                            {
                                b: "https://images.unsplash.com/photo-1580489944761-15a19d654956?q=80&w=600&auto=format&fit=crop",
                                a: "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?q=80&w=600&auto=format&fit=crop",
                ...
                <div className="container mx-auto max-w-6xl relative z-10">
                    <div className="text-center mb-16 max-w-3xl mx-auto">
                        <FadeIn direction="up">
                            ...
                            <h2 className="text-4xl sm:text-5xl font-serif text-luxury-nude mb-6">Video <span className="text-luxury-gold italic pr-2">Showcase</span></h2>
                            <div className="w-12 h-[1px] bg-luxury-gold mx-auto mb-6"></div>
                            <p className="text-luxury-nude/70 font-light text-base md:text-lg leading-relaxed px-4">
                                Watch the magic unfold. See real-time transformations and behind-the-scenes moments captured in motion.
                            </p>
                        </FadeIn>
                    </div>
